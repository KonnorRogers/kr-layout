...
>
  ...
  ></path>
</svg>`;function w(){return window.matchMedia("(prefers-reduced-motion: reduce)")===!0||window.matchMedia("(prefers-reduced-motion: reduce)").matches===!0}var o=class extends c{constructor(){super(),this.summary="",this.open=!1,this._openOnToggle=!0}willUpdate(t){let e=this.details;e&&t.has("open")&&(this.open?(e.open=this.open,this._openOnToggle=!1,requestAnimationFrame(()=>{requestAnimationFrame(()=>{e.setAttribute("expanded",""),this._openOnToggle=!0,this.dispatchEvent(new Event("light-toggle"))})})):(e.hasAttribute("expanded")?e.removeAttribute("expanded"):e.open=this.open,w()&&(e.open=this.open),this.dispatchEvent(new Event("light-toggle"))))}click(){this.open=!this.open}focus(t){this.shadowRoot?.querySelector("summary")?.focus(t)}render(){return r`
      <details
        part="details"
    ...
    `]),i(o,"properties",{summary:{},open:{type:Boolean}});export{b as a,A as b,M as c,k as d,o as e};
...
lit-html/directives/if-defined.js:
   ...
   *)
*/
//# sourceMappingURL=/kr-layout/pull/1/bridgetown/static/chunks/chunk-D5VP72NZ.js.map
